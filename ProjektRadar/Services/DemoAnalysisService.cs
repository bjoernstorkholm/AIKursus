...
public sealed class DemoAnalysisService
{
    public Task<ProjectAnalysis> AnalyzeAsync(IReadOnlyList<UploadedDocument> documents)
    {
        ...
        var analysis = new ProjectAnalysis
        {
            ...
            RadarMetrics = new List<RadarMetric>
            {
                new("Tidsplan", 84),
                new("Økonomi", 76),
                new("Sikkerhed", 91),
            ...
            Risks = new List<ProjectRisk>
            {
                new(
                    "Go-live uden afsluttet sikkerhedstest",
                    "Sikkerhedstesten kan først afsluttes efter den dato, som projektplanen fortsat angiver som go-live.",
                    "Høj",
                    "Kritisk",
                    92,
                    "Kritisk",
                    "04_Sikkerhed_og_testplan_Aurora.docx – side 3; 02_Projektplan_Aurora.docx – side 4"),
                new(
                    "Budgetoverskridelse uden godkendt finansiering",
                    "Seneste forecast er højere end den godkendte ramme, mens finansiering af merforbruget ikke fremgår som besluttet.",
                    "Høj",
                    "Høj",
                    81,
                    "Høj",
                    "03_Budget_Aurora.xlsx – Forecast; 01_Projektcharter_Aurora.docx – side 2"),
                new(
                    "Uklart dataejerskab",
                    "Projektcharter og dataejerskabsnotat peger på forskellige ejere af de centrale dataobjekter.",
                    "Mellem",
                    "Høj",
                    72,
                    "Høj",
                    "05_Dataejerskab_Aurora.pdf – side 2; 01_Projektcharter_Aurora.docx – side 3"),
                new(
                    "Leverandørkapacitet er overvurderet",
                    "Statusmaterialet viser grøn leverandørstatus, men leverandørens egen plan mangler navngivne testressourcer i kritiske uger.",
                    "Mellem",
                    "Høj",
                    68,
                    "Høj",
                    "06_Leverandorstatus_Aurora.pptx – slide 4; 07_Risikolog_Aurora.csv – række 5")
            },
            Conflicts = new List<DocumentConflict>
            {
                new(
                    "Go-live-dato",
            ...
            MissingDecisions = new List<MissingDecision>
            {
